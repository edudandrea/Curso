        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventoId = table.Column<int>(type: "INTEGER", nullable: false),
                    PalestranteEventoId = table.Column<int>(type: "INTEGER", nullable: false),
                    PalestranteID1 = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PalestrantesEventos_PalestrantesEventos_PalestranteEventoId_PalestranteID1",
                        columns: x => new { x.PalestranteEventoId, x.PalestranteID1 },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RedesSociais_Palestrantes_PalestrantesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PalestrantesEventos_PalestranteEventoId_PalestranteID1",
                table: "PalestrantesEventos",
                columns: new[] { "PalestranteEventoId", "PalestranteID1" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedesSociais_PalestrantesId",
                table: "RedesSociais",
